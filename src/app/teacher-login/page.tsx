...
import {setTeacher, setError as setTeacherError, setLoading, clearError } from "../../redux/teacherSlice"
...
export default function Login() {
    ...
    const { loading, error, success } = useSelector((state: RootState) => state.teacher)
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            dispatch(setTeacherError(errorMessage))
        } finally {
