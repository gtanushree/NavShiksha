...
import Logoimage from "@/assets/logowhatsapp-removebg-preview.png"
...
export default function SidebarDemo({ components }: { components: any }) {
    const links = [
        ...
        // },
        {
            ...
            href: "#",
            icon: (
                <IconTimelineEventText className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
            ),
        },
        {
